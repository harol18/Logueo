...
namespace Usuarios_planta
{
    ...
    {        
        ...
        private void BtnReportes_Click(object sender, EventArgs e)
        {
            ...
            string pass = Microsoft.VisualBasic.Interaction.InputBox("Digite su contraseña","Contraseña para ingresar",""); //inputbox de visual basic, se debe referenciar microsoft.visualbasic 
            if (pass=="Indr42020")
            {
